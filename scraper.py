...
def main():
    ...
    parser.add_argument("--devid", default="", help="Screenscraper DevID (if required by your API contract).")
    parser.add_argument("--devpassword", default="", help="Screenscraper DevPassword.")
